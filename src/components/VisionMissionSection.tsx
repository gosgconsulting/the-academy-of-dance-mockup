      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-0 bg-white hover:scale-105 shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50">
            ...
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-0 bg-white hover:scale-105 shadow-lg shadow-yellow-600/30 hover:shadow-yellow-600/50">
              <CardContent className="p-8">
            ...
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-0 bg-white hover:scale-105 shadow-lg shadow-orange-700/30 hover:shadow-orange-700/50">
              <CardContent className="p-8">
