      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-0 bg-white hover:scale-105 shadow-2xl shadow-violet-500/30 hover:shadow-violet-500/50">
            ...
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-0 bg-white hover:scale-105 shadow-2xl shadow-emerald-500/30 hover:shadow-emerald-500/50">
              <CardContent className="p-8">
            ...
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-0 bg-white hover:scale-105 shadow-2xl shadow-orange-500/30 hover:shadow-orange-500/50">
              <CardContent className="p-8">
