            ...
            <Carousel className="w-full" opts={{
              ...
              <CarouselContent>
                {[{
                  ...
                  content: "The progress my daughter has made in just one year is incredible. She's gained so much confidence and technical skill. The teachers are patient and encouraging.",
                  rating: 5
                }, {
                  name: "Lisa Kumar",
                  role: "Parent of Aiden, Age 7",
                  content: "My son absolutely loves his dance classes here. The variety of styles offered means he never gets bored, and the competition opportunities have been amazing.",
                  rating: 5
                }, {
                  name: "Jennifer Lim",
                  role: "Parent of Maya, Age 9",
                  content: "The Academy provides such a nurturing environment. My daughter has blossomed here, not just as a dancer but as a confident young person.",
                  rating: 5
                }, {
                  name: "Robert Lee",
                  role: "Parent of twins Alex & Anna, Age 11",
                  content: "Having both my children learn here has been fantastic. The teachers adapt to each child's learning style and the community is so supportive.",
                  rating: 5
                }, {
                  name: "Amanda Teo",
                  role: "Parent of Chloe, Age 5",
                  content: "Starting dance at such a young age here was the best decision. The Baby Gems program is perfect for little ones - creative, fun and educational.",
                  rating: 5
                }].map((review, index) => (
                  <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <Card className="p-6 hover:shadow-lg transition-shadow duration-300 h-full">
                      <CardContent className="space-y-4 p-0 flex flex-col h-full">
                        ...
                        <p className="text-gray-700 italic flex-1">"{review.content}"</p>
                        <div>
