...
With twirls to Disney tunes and skips to nursery rhymes, it builds confidence, creativity, and sets the stage for classical training.</p>
      ...
      {/* WhatsApp Button */}
      <a href="https://wa.me/6598372670" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110" aria-label="Contact us on WhatsApp">
