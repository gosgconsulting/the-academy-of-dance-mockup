...
const authors = [
  { name: "Sarah Chen", posts: 15 },
  { name: "Marcus Williams", posts: 12 },
  { name: "Elena Rodriguez", posts: 8 },
  { name: "David Kim", posts: 10 },
  { name: "Dr. Amy Thompson", posts: 6 }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {categories.map((category) => (
                    <div key={category.name} className="flex justify-between items-center hover:text-primary cursor-pointer transition-colors">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {authors.map((author) => (
                    <div key={author.name} className="flex justify-between items-center hover:text-primary cursor-pointer transition-colors">
