...
import { privacyPolicyDefaults, type PrivacyPolicyContent } from "@/cms/content/schemas/legal";

const PrivacyPolicy = () => {
  const { data } = usePageContent<PrivacyPolicyContent>('privacy-policy', privacyPolicyDefaults)
