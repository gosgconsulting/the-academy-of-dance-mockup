...
class Pinegrow_Plugin_Public {
	...
	public function get_editor_scripts() {
        ...
        if(PG_LOAD_LOCAL_PINECONE) {
            ...
            $scripts[] = "lib/crsa/plugins/pine.cone/pg.pine.cone.edit.js";
        } else {
            $scripts[] = "https://pinegrow.com/pine.cone.6/pine.cone.combined.min.js";
        }
        ...
        if(PG_FEATURES_TW) {
            ...
            $scripts[] = "frameworks/tailwindcss/tailwind.interface.js";
            $scripts[] = "frameworks/tailwindcss/tailwind.parser.js";
            //$scripts[] = "frameworks/tailwindcss/resources/tailwind.parser.js";
