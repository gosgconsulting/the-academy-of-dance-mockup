...
<body></body>
</html>`),a.addHiddenFile("_new.html",i),a.addStylesheet("css/normalize.css",pgSVGIcons.css_normalize),a.addStylesheet("css/style.css",""),s.addLesson(a),(i=new PgTutorialLesson("new_html_blocks",null)).name="HTML Blocks",a=`<!DOCTYPE html>
...
</html>`),i.addHiddenFile("_new.html",a),i.addStylesheet("css/normalize.css",pgSVGIcons.css_normalize),i.addStylesheet("css/style.css",""),i.addStylesheet("about-me.css",`.cool-blocks-about-me {
    display: grid;
...
`),s.addLesson(i),(a=new PgTutorialLesson("new_bs")).name="Blank Bootstrap Project",i=`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
`,a.addPage("index.html",i),a.addHiddenFile("_new.html",i),a.addStylesheet("css/style.css",""),a.addResource("assets/js/popper.min.js","frameworks/bootstrap5/template/assets/js/popper.min.js"),a.addResource("bootstrap/js/bootstrap.min.js","frameworks/bootstrap5/template/bootstrap/js/bootstrap.min.js"),a.addResource("bootstrap/css/bootstrap.min.css","frameworks/bootstrap5/template/bootstrap/css/bootstrap.min.css"),s.addLesson(a),(i=new PgTutorialLesson("new_bs_blocks")).name="Bootstrap Blocks Project",a=`<!DOCTYPE html>
<html lang="en" wp-template>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
`,i.addPage("index.html",`<!DOCTYPE html>
<html lang="en" wp-template>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
`),i.addHiddenFile("_new.html",a),i.addStylesheet("css/style.css",""),i.addResource("assets/js/popper.min.js","frameworks/bootstrap5/template/assets/js/popper.min.js"),i.addResource("bootstrap/js/bootstrap.min.js","frameworks/bootstrap5/template/bootstrap/js/bootstrap.min.js"),i.addResource("bootstrap/css/bootstrap.min.css","frameworks/bootstrap5/template/bootstrap/css/bootstrap.min.css"),s.addLesson(i),(a=new PgTutorialLesson("new_tw")).name="Blank Tailwind Project",i=`<!DOCTYPE html> 
<html lang="en"> 
    <head> 
        <meta charset="utf-8"/> 
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/> 
...
</html>`,a.addPage("index.html",i),a.addHiddenFile("_new.html",i),a.addStylesheet("tailwind_theme/tailwind.css",`/*
...
</project>`),s.addLesson(a),(i=new PgTutorialLesson("new_tw4")).name="Blank Tailwind 4 Project",a=`<!DOCTYPE html> 
<html lang="en"> 
    <head> 
        <meta charset="utf-8"> 
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
...
`,i.addPage("index.html",a),i.addHiddenFile("_new.html",a),i.addStylesheet("tailwind_theme/tailwind.css",`/*! tailwindcss v4.0.0 | MIT License | https://tailwindcss.com */
...
`),i.addPage("pinegrow.json",`{"files":{"index.html":{"frameworks":["tw4","pg.tw.lib","pg.insight.events","pg.asset.manager","pg.svg.lib","pg.project.items","pg.css.grid","pg.code-validator","pg.image.overlay","tw","pg.html","pine.cone.lib","pg.components"]}},"breakpoints":[],"frameworks":["tw4","pg.tw.lib","pg.insight.events","pg.asset.manager","pg.svg.lib","pg.project.items","pg.css.grid","pg.code-validator","pg.image.overlay","tw","pg.html","pine.cone.lib","pg.components"],"template_framework_id":"tailwind","urls":{"index.html":{"open-page-views":[{"w":1024,"h":0}],"open-with-wrapper":false}},"open-pages":["index.html"],"active-design-provider":"tw","design-settings":{"mode":"jit4","external_source_url":null,"custom_config":null,"add_setting":null,"custom_source_url":null,"disable_preflight":null,"external_config_url":null,"external_help":null}}`),i.addPage("projectdb.pgml",`<project>
    <documents></documents>
    <dmdesigns>
        <dmdesign active>
            <dmdesignskill skill="tw.colors">
                <dmcolor key="red" color="oklch(0.637 0.237 25.331)" shade-50="oklch(0.971 0.013 17.38)" shade-100="oklch(0.936 0.032 17.717)" shade-200="oklch(0.885 0.062 18.334)" shade-300="oklch(0.808 0.114 19.571)" shade-400="oklch(0.704 0.191 22.216)" shade-500="oklch(0.637 0.237 25.331)" shade-600="oklch(0.577 0.245 27.325)" shade-700="oklch(0.505 0.213 27.518)" shade-800="oklch(0.444 0.177 26.899)" shade-900="oklch(0.396 0.141 25.723)" shade-950="oklch(0.258 0.092 26.042)"/>
                <dmcolor key="orange" color="oklch(0.705 0.213 47.604)" shade-50="oklch(0.98 0.016 73.684)" shade-100="oklch(0.954 0.038 75.164)" shade-200="oklch(0.901 0.076 70.697)" shade-300="oklch(0.837 0.128 66.29)" shade-400="oklch(0.75 0.183 55.934)" shade-500="oklch(0.705 0.213 47.604)" shade-600="oklch(0.646 0.222 41.116)" shade-700="oklch(0.553 0.195 38.402)" shade-800="oklch(0.47 0.157 37.304)" shade-900="oklch(0.408 0.123 38.172)" shade-950="oklch(0.266 0.079 36.259)"/>
                <dmcolor key="amber" color="oklch(0.769 0.188 70.08)" shade-50="oklch(0.987 0.022 95.277)" shade-100="oklch(0.962 0.059 95.617)" shade-200="oklch(0.924 0.12 95.746)" shade-300="oklch(0.879 0.169 91.605)" shade-400="oklch(0.828 0.189 84.429)" shade-500="oklch(0.769 0.188 70.08)" shade-600="oklch(0.666 0.179 58.318)" shade-700="oklch(0.555 0.163 48.998)" shade-800="oklch(0.473 0.137 46.201)" shade-900="oklch(0.414 0.112 45.904)" shade-950="oklch(0.279 0.077 45.635)"/>
                <dmcolor key="yellow" color="oklch(0.795 0.184 86.047)" shade-50="oklch(0.987 0.026 102.212)" shade-100="oklch(0.973 0.071 103.193)" shade-200="oklch(0.945 0.129 101.54)" shade-300="oklch(0.905 0.182 98.111)" shade-400="oklch(0.852 0.199 91.936)" shade-500="oklch(0.795 0.184 86.047)" shade-600="oklch(0.681 0.162 75.834)" shade-700="oklch(0.554 0.135 66.442)" shade-800="oklch(0.476 0.114 61.907)" shade-900="oklch(0.421 0.095 57.708)" shade-950="oklch(0.286 0.066 53.813)"/>
                <dmcolor key="lime" color="oklch(0.768 0.233 130.85)" shade-50="oklch(0.986 0.031 120.757)" shade-100="oklch(0.967 0.067 122.328)" shade-200="oklch(0.938 0.127 124.321)" shade-300="oklch(0.897 0.196 126.665)" shade-400="oklch(0.841 0.238 128.85)" shade-500="oklch(0.768 0.233 130.85)" shade-600="oklch(0.648 0.2 131.684)" shade-700="oklch(0.532 0.157 131.589)" shade-800="oklch(0.453 0.124 130.933)" shade-900="oklch(0.405 0.101 131.063)" shade-950="oklch(0.274 0.072 132.109)"/>
                <dmcolor key="green" color="oklch(0.723 0.219 149.579)" shade-50="oklch(0.982 0.018 155.826)" shade-100="oklch(0.962 0.044 156.743)" shade-200="oklch(0.925 0.084 155.995)" shade-300="oklch(0.871 0.15 154.449)" shade-400="oklch(0.792 0.209 151.711)" shade-500="oklch(0.723 0.219 149.579)" shade-600="oklch(0.627 0.194 149.214)" shade-700="oklch(0.527 0.154 150.069)" shade-800="oklch(0.448 0.119 151.328)" shade-900="oklch(0.393 0.095 152.535)" shade-950="oklch(0.266 0.065 152.934)"/>
                <dmcolor key="emerald" color="oklch(0.696 0.17 162.48)" shade-50="oklch(0.979 0.021 166.113)" shade-100="oklch(0.95 0.052 163.051)" shade-200="oklch(0.905 0.093 164.15)" shade-300="oklch(0.845 0.143 164.978)" shade-400="oklch(0.765 0.177 163.223)" shade-500="oklch(0.696 0.17 162.48)" shade-600="oklch(0.596 0.145 163.225)" shade-700="oklch(0.508 0.118 165.612)" shade-800="oklch(0.432 0.095 166.913)" shade-900="oklch(0.378 0.077 168.94)" shade-950="oklch(0.262 0.051 172.552)"/>
                <dmcolor key="teal" color="oklch(0.704 0.14 182.503)" shade-50="oklch(0.984 0.014 180.72)" shade-100="oklch(0.953 0.051 180.801)" shade-200="oklch(0.91 0.096 180.426)" shade-300="oklch(0.855 0.138 181.071)" shade-400="oklch(0.777 0.152 181.912)" shade-500="oklch(0.704 0.14 182.503)" shade-600="oklch(0.6 0.118 184.704)" shade-700="oklch(0.511 0.096 186.391)" shade-800="oklch(0.437 0.078 188.216)" shade-900="oklch(0.386 0.063 188.416)" shade-950="oklch(0.277 0.046 192.524)"/>
                <dmcolor key="cyan" color="oklch(0.715 0.143 215.221)" shade-50="oklch(0.984 0.019 200.873)" shade-100="oklch(0.956 0.045 203.388)" shade-200="oklch(0.917 0.08 205.041)" shade-300="oklch(0.865 0.127 207.078)" shade-400="oklch(0.789 0.154 211.53)" shade-500="oklch(0.715 0.143 215.221)" shade-600="oklch(0.609 0.126 221.723)" shade-700="oklch(0.52 0.105 223.128)" shade-800="oklch(0.45 0.085 224.283)" shade-900="oklch(0.398 0.07 227.392)" shade-950="oklch(0.302 0.056 229.695)"/>
                <dmcolor key="sky" color="oklch(0.685 0.169 237.323)" shade-50="oklch(0.977 0.013 236.62)" shade-100="oklch(0.951 0.026 236.824)" shade-200="oklch(0.901 0.058 230.902)" shade-300="oklch(0.828 0.111 230.318)" shade-400="oklch(0.746 0.16 232.661)" shade-500="oklch(0.685 0.169 237.323)" shade-600="oklch(0.588 0.158 241.966)" shade-700="oklch(0.5 0.134 242.749)" shade-800="oklch(0.443 0.11 240.79)" shade-900="oklch(0.391 0.09 240.876)" shade-950="oklch(0.293 0.066 243.157)"/>
                <dmcolor key="blue" color="oklch(0.623 0.214 259.815)" shade-50="oklch(0.97 0.014 254.604)" shade-100="oklch(0.932 0.032 255.585)" shade-200="oklch(0.882 0.059 254.128)" shade-300="oklch(0.809 0.105 251.813)" shade-400="oklch(0.707 0.165 254.624)" shade-500="oklch(0.623 0.214 259.815)" shade-600="oklch(0.546 0.245 262.881)" shade-700="oklch(0.488 0.243 264.376)" shade-800="oklch(0.424 0.199 265.638)" shade-900="oklch(0.379 0.146 265.522)" shade-950="oklch(0.282 0.091 267.935)"/>
                <dmcolor key="indigo" color="oklch(0.585 0.233 277.117)" shade-50="oklch(0.962 0.018 272.314)" shade-100="oklch(0.93 0.034 272.788)" shade-200="oklch(0.87 0.065 274.039)" shade-300="oklch(0.785 0.115 274.713)" shade-400="oklch(0.673 0.182 276.935)" shade-500="oklch(0.585 0.233 277.117)" shade-600="oklch(0.511 0.262 276.966)" shade-700="oklch(0.457 0.24 277.023)" shade-800="oklch(0.398 0.195 277.366)" shade-900="oklch(0.359 0.144 278.697)" shade-950="oklch(0.257 0.09 281.288)"/>
                <dmcolor key="violet" color="oklch(0.606 0.25 292.717)" shade-50="oklch(0.969 0.016 293.756)" shade-100="oklch(0.943 0.029 294.588)" shade-200="oklch(0.894 0.057 293.283)" shade-300="oklch(0.811 0.111 293.571)" shade-400="oklch(0.702 0.183 293.541)" shade-500="oklch(0.606 0.25 292.717)" shade-600="oklch(0.541 0.281 293.009)" shade-700="oklch(0.491 0.27 292.581)" shade-800="oklch(0.432 0.232 292.759)" shade-900="oklch(0.38 0.189 293.745)" shade-950="oklch(0.283 0.141 291.089)"/>
                <dmcolor key="purple" color="oklch(0.627 0.265 303.9)" shade-50="oklch(0.977 0.014 308.299)" shade-100="oklch(0.946 0.033 307.174)" shade-200="oklch(0.902 0.063 306.703)" shade-300="oklch(0.827 0.119 306.383)" shade-400="oklch(0.714 0.203 305.504)" shade-500="oklch(0.627 0.265 303.9)" shade-600="oklch(0.558 0.288 302.321)" shade-700="oklch(0.496 0.265 301.924)" shade-800="oklch(0.438 0.218 303.724)" shade-900="oklch(0.381 0.176 304.987)" shade-950="oklch(0.291 0.149 302.717)"/>
                <dmcolor key="fuchsia" color="oklch(0.667 0.295 322.15)" shade-50="oklch(0.977 0.017 320.058)" shade-100="oklch(0.952 0.037 318.852)" shade-200="oklch(0.903 0.076 319.62)" shade-300="oklch(0.833 0.145 321.434)" shade-400="oklch(0.74 0.238 322.16)" shade-500="oklch(0.667 0.295 322.15)" shade-600="oklch(0.591 0.293 322.896)" shade-700="oklch(0.518 0.253 323.949)" shade-800="oklch(0.452 0.211 324.591)" shade-900="oklch(0.401 0.17 325.612)" shade-950="oklch(0.293 0.136 325.661)"/>
                <dmcolor key="pink" color="oklch(0.656 0.241 354.308)" shade-50="oklch(0.971 0.014 343.198)" shade-100="oklch(0.948 0.028 342.258)" shade-200="oklch(0.899 0.061 343.231)" shade-300="oklch(0.823 0.12 346.018)" shade-400="oklch(0.718 0.202 349.761)" shade-500="oklch(0.656 0.241 354.308)" shade-600="oklch(0.592 0.249 0.584)" shade-700="oklch(0.525 0.223 3.958)" shade-800="oklch(0.459 0.187 3.815)" shade-900="oklch(0.408 0.153 2.432)" shade-950="oklch(0.284 0.109 3.907)"/>
                <dmcolor key="rose" color="oklch(0.645 0.246 16.439)" shade-50="oklch(0.969 0.015 12.422)" shade-100="oklch(0.941 0.03 12.58)" shade-200="oklch(0.892 0.058 10.001)" shade-300="oklch(0.81 0.117 11.638)" shade-400="oklch(0.712 0.194 13.428)" shade-500="oklch(0.645 0.246 16.439)" shade-600="oklch(0.586 0.253 17.585)" shade-700="oklch(0.514 0.222 16.935)" shade-800="oklch(0.455 0.188 13.697)" shade-900="oklch(0.41 0.159 10.272)" shade-950="oklch(0.271 0.105 12.094)"/>
                <dmcolor key="slate" color="oklch(0.554 0.046 257.417)" shade-50="oklch(0.984 0.003 247.858)" shade-100="oklch(0.968 0.007 247.896)" shade-200="oklch(0.929 0.013 255.508)" shade-300="oklch(0.869 0.022 252.894)" shade-400="oklch(0.704 0.04 256.788)" shade-500="oklch(0.554 0.046 257.417)" shade-600="oklch(0.446 0.043 257.281)" shade-700="oklch(0.372 0.044 257.287)" shade-800="oklch(0.279 0.041 260.031)" shade-900="oklch(0.208 0.042 265.755)" shade-950="oklch(0.129 0.042 264.695)"/>
                <dmcolor key="gray" color="oklch(0.551 0.027 264.364)" shade-50="oklch(0.985 0.002 247.839)" shade-100="oklch(0.967 0.003 264.542)" shade-200="oklch(0.928 0.006 264.531)" shade-300="oklch(0.872 0.01 258.338)" shade-400="oklch(0.707 0.022 261.325)" shade-500="oklch(0.551 0.027 264.364)" shade-600="oklch(0.446 0.03 256.802)" shade-700="oklch(0.373 0.034 259.733)" shade-800="oklch(0.278 0.033 256.848)" shade-900="oklch(0.21 0.034 264.665)" shade-950="oklch(0.13 0.028 261.692)"/>
                <dmcolor key="zinc" color="oklch(0.552 0.016 285.938)" shade-50="oklch(0.985 0 0)" shade-100="oklch(0.967 0.001 286.375)" shade-200="oklch(0.92 0.004 286.32)" shade-300="oklch(0.871 0.006 286.286)" shade-400="oklch(0.705 0.015 286.067)" shade-500="oklch(0.552 0.016 285.938)" shade-600="oklch(0.442 0.017 285.786)" shade-700="oklch(0.37 0.013 285.805)" shade-800="oklch(0.274 0.006 286.033)" shade-900="oklch(0.21 0.006 285.885)" shade-950="oklch(0.141 0.005 285.823)"/>
                <dmcolor key="neutral" color="oklch(0.556 0 0)" shade-50="oklch(0.985 0 0)" shade-100="oklch(0.97 0 0)" shade-200="oklch(0.922 0 0)" shade-300="oklch(0.87 0 0)" shade-400="oklch(0.708 0 0)" shade-500="oklch(0.556 0 0)" shade-600="oklch(0.439 0 0)" shade-700="oklch(0.371 0 0)" shade-800="oklch(0.269 0 0)" shade-900="oklch(0.205 0 0)" shade-950="oklch(0.145 0 0)"/>
                <dmcolor key="stone" color="oklch(0.553 0.013 58.071)" shade-50="oklch(0.985 0.001 106.423)" shade-100="oklch(0.97 0.001 106.424)" shade-200="oklch(0.923 0.003 48.717)" shade-300="oklch(0.869 0.005 56.366)" shade-400="oklch(0.709 0.01 56.259)" shade-500="oklch(0.553 0.013 58.071)" shade-600="oklch(0.444 0.011 73.639)" shade-700="oklch(0.374 0.01 67.558)" shade-800="oklch(0.268 0.007 34.298)" shade-900="oklch(0.216 0.006 56.043)" shade-950="oklch(0.147 0.004 49.25)"/>
            </dmdesignskill>
            <dmdesignskill skill="fonts"></dmdesignskill>
            <dmdesignskill skill="background" image_for_colors="true" advanced="true" filter_blur="0" filter_brightness="100" filter_contrast="100" filter_grayscale="0" filter_hue-rotate="0" filter_invert="0" filter_opacity="100" filter_saturate="100" filter_sepia="0"></dmdesignskill>
            <dmdesignskill skill="tailwind"></dmdesignskill>
    ...
    <dmlocked tw-colors-red="true" tw-colors-orange="true" tw-colors-amber="true" tw-colors-yellow="true" tw-colors-lime="true" tw-colors-green="true" tw-colors-emerald="true" tw-colors-teal="true" tw-colors-cyan="true" tw-colors-sky="true" tw-colors-blue="true" tw-colors-indigo="true" tw-colors-violet="true" tw-colors-purple="true" tw-colors-fuchsia="true" tw-colors-pink="true" tw-colors-rose="true" tw-colors-slate="true" tw-colors-gray="true" tw-colors-zinc="true" tw-colors-neutral="true" tw-colors-stone="true"></dmlocked>
</project>`),s.addLesson(i),(a=new PgTutorialLesson("new_tw_blocks")).name="Tailwind Blocks Project",i=`<!DOCTYPE html> 
<html lang="en" wp-template> 
    <head> 
        <meta charset="utf-8"/> 
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/> 
...
`),a.addPage("pinegrow.json",`{"files":{"index.html":{"frameworks":["newtw2","pg.insight.events","pg.svg.lib","pg.css.grid","pg.image.overlay","pg.code-validator","pg.project.items","pg.asset.manager","pg.tw.lib","tw","pg.html","pg.components"],"last_page_width":1024}},"breakpoints":[],"frameworks":["newtw2","pg.insight.events","pg.svg.lib","pg.css.grid","pg.image.overlay","pg.code-validator","pg.project.items","pg.asset.manager","pg.tw.lib","tw","pg.html","pg.components"],"template_framework_id":"tailwind","urls":{"index.html":{"open-page-views":[{"w":1024,"h":0}]}},"active-design-provider":"tw"}`),a.addPage("projectdb.pgml",`<project>
    ...
    <dmlocked tw-colors-gray="true" tw-colors-red="true" tw-colors-yellow="true" tw-colors-green="true" tw-colors-blue="true" tw-colors-indigo="true" tw-colors-purple="true" tw-colors-pink="true"></dmlocked>
</project>`),s.addLesson(a),(l=new PgTutorialLesson("new_tw_block_theme")).name="Block Theme Tailwind Project",i=`<!DOCTYPE html> 
...
</html>`,l.addPage("index.html",i),l.addHiddenFile("_new.html",i),l.addStylesheet("tailwind_theme/tailwind.css",`@import url('https://fonts.googleapis.com/css?family=Sora:100,200,300,400,500,600,700,800&display=swap');
...
`),l.addStylesheet("tailwind_theme/tailwind_for_wp_editor.css",`@import url('https://fonts.googleapis.com/css?family=Sora:100,200,300,400,500,600,700,800&display=swap');
...
*/`),l.addPage("additional-editor-styles.css",`body {
    padding-left: 2rem;
    padding-right: 2rem;
}`),s.addLesson(l);(e=new PgTutorialLesson("new_pinekit")).name="Blank Pinekit Project",a=`<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
